...
// Virtual inheritance because we don't want members to be inherited multple times, and diamond problem not occure 
...
public:
    ...
    // why ,sir have not written the parameterless ctor ?-> becoz base class will be called implicitely
    ...
    void accept()
    {
        Employee::accept();// employee ka acept aayega , using scope resolation operator 
        acceptManager();// ye manager ka accept hai 
    }
    void display()
    {
        Employee::display();
...
protected://  kyon ki ise mujhe sirf isi me use karni hain and apni inherrited class me bas ...
    void acceptManager()
    {
        cout << "Enter Bonus: ";
        cin >> bonus;
...
enum e_choice//  yaha e_choice ek class ke naam ki tarah hai 
{
    Exit,
    addManager,
    addSalesman,
...
// half coading done --> structure code ka ban gya hai .....
